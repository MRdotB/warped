...
Game.Play.prototype = {
    ...
    twitter: function ()
    {
        ...
        {
            hozMove = 2000;
            window.open('http://twitter.com/share?text=I+just+beat+Warped!+and+only+died+' + deaths + '+times+See+if+you+can+beat+it+at&via=rantt_&url=http://http://localhost:8888/git/warped2/', '_blank');
        }, this);
